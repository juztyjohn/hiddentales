...
export default function PlaceViewScreen() {
  ...
  cart.bookingPrice = cart.itemsPrice > 100 ? round2(0) : round2(10);
  cart.taxPrice = round2(0.15 * cart.itemsPrice);
  cart.totalPrice = cart.itemsPrice + cart.bookingPrice + cart.taxPrice;
                  ...
                  <ListGroup.Item key={item._id}>
                    <Row className="align-items-center">
                      <Col md={6}>
                        ...
                        ></img>{' '}
                        <Link to={`/place/${item.slug}`}>{item.name}</Link>
                      </Col>
                      <Col md={3}>
            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <Row>
                    <Col>Booking</Col>
                    <Col>${cart.bookingPrice.toFixed(2)}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
